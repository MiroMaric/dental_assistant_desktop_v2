...
import com.mikomaric.dentalassistant.form.cardboard.FormSearchCardboard;
import com.mikomaric.dentalassistant.domain.Appointment;
import com.mikomaric.dentalassistant.form.cardboard.FormNewCardboard;
...
import com.mikomaric.dentalassistant.utill.SettingsLoader;
...
public class FormMain extends javax.swing.JFrame {
    ...
    private void prepareSchedule() {
        ...
        try {
            appointments = Controller.getInstance().getAllAppointments();
        } catch (Exception ex) {
