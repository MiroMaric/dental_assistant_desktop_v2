...
import com.mikomaric.dentalassistant.form.TableModelToothInterventions;
import com.mikomaric.dentalassistant.form.component.PanelAllTeethView;
import com.mikomaric.dentalassistant.form.component.PanelJaw;
import com.mikomaric.dentalassistant.form.component.PanelLegend;
import com.mikomaric.dentalassistant.form.component.PanelTeeth;
import com.mikomaric.dentalassistant.form.component.PanelTooth;
import com.mikomaric.dentalassistant.form.component.PanelToothSides;
import com.mikomaric.dentalassistant.form.component.intervention.PanelNewIntervention;
import com.mikomaric.dentalassistant.form.component.menu_item.PanelMenuBar;
import com.mikomaric.dentalassistant.icon.FalseIcon;
...
//        try {
//            this.patient = com.mikomaric.dentalassistant.controller.Controller.getInstance().findCardboard(new Patient("7bbd3175-ee4d-4601-8278-11b2848f9a56"));
//        } catch (Exception ex) {
...
//        }
    ...
    private void initComponents() {
        ...
        scrollPaneSouth.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
        scrollPaneSouth.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        scrollPaneSouth.setPreferredSize(new java.awt.Dimension(2000, 100));
