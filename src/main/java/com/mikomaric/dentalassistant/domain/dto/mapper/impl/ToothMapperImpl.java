...
public class ToothMapperImpl implements ToothMapper {
    ...
    private final ToothInterventionMapper toothInterventionMapper = Mappers.getMapper( ToothInterventionMapper.class );
    ...
    public Tooth toothDtoToTooth(ToothDto dto) {
        ...
        tooth.setToothInterventions( toothInterventionMapper.toothInterventiondDtoToToothIntervention( dto.getToothInterventions() ) );
    ...
    public ToothDto toothToToothDto(Tooth tooth) {
        ...
        toothDto.setToothInterventions( toothInterventionMapper.toothInterventionToToothInterventionDto( tooth.getToothInterventions() ) );
